...
const Settings = (() => {
  ...
  function readUI() {
    return {
      ...
      clockWeight: parseInt(document.getElementById('setting-clock-weight').value, 10) || 400,
      clockSize: parseInt(document.getElementById('setting-clock-size-num').value, 10) || 160,
